#!/bin/bash
export ip1=$(wget -qO- ifconfig.me)
...
echo -e ""
echo -e "$biru┌──────────────────────────────────────────┐$NC"
echo -e "$biru│      ${hijau} CREADOR DE SUBDOMINIOS BY @darnix0|@darnix0      $biru│$NC"
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e "$biru┌──────────────────────────────────────────┐$NC"
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
read -rp "seleccione el subdominio: " host
echo -e ""
#domain 1
if [ $host -eq 1 ]
then
...
DOMAIN1=alawistore.my.id
  echo -e ""
  echo -e "$biru┌──────────────────────────────────────────┐$NC"
  echo -e "$biru│      ${hijau} CREADOR DE SUBDOMINIOS BY @botlatmx       $biru│$NC"
  echo -e "$biru└──────────────────────────────────────────┘$NC"
  echo -e "$biru------>$NC  ${hijau}xxx.${DOMAIN1}  $biru<------$NC"
  echo -e ""
  read -rp "ingrese un subdominio [ejemplo: elchilakas] " -e sub1
ip1=$(wget -qO- ifconfig.me)
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN1}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN01}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN1}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e ""
echo -e "$biru┌──────────────────────────────────────────┐$NC"
echo -e "$biru│   ${hijau}CREADOR DE SUBDOMINIOS KE CLOUDFLARE SELESAI  $biru│$NC"
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN1}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
pointing
...
DOMAIN2=alawistore.biz.id
  echo -e ""
  echo -e "$biru┌──────────────────────────────────────────┐$NC"
  echo -e "$biru│      ${hijau} CREADOR DE SUBDOMINIOS BY @darnix0       $biru│$NC"
  echo -e "$biru└──────────────────────────────────────────┘$NC"
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN2}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN02}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN2}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN2}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN3}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN03}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN3}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN3}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN4}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN04}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN4}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN4}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN5}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN05}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN5}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN5}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN6}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN06}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN6}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN6}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN7}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN07}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN7}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN7}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN8}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN08}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN8}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN8}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN9}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN09}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN9}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN9}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN10}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN010}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN10}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN10}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN11}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN011}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN11}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN11}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN12}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN012}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN12}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN12}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN13}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN013}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN13}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN13}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN14}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN014}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN14}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN14}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN15}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN015}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN15}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN15}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
...
hijau="\e[92;1m"
echo -e ""
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN16}$NC..."
...
echo -e "${hijau}\e[92m[✓] proceso completado exitosamente [✓]$NC"
#zoomcares.zoom.us
echo -e "\e[92mENLAZANDO IP: $ip1 ==>>  ${biru}${SUB_DOMAIN016}$NC..."
ZONE=$(curl -sLX GET "https://api.cloudflare.com/client/v4/zones?name=${DOMAIN16}&status=active" \
-H "X-Auth-Email: ${CF_ID}" \
-H "X-Auth-Key: ${CF_KEY}" \
-H "Content-Type: application/json" | jq -r .result[0].id)
...
echo -e "$biru└──────────────────────────────────────────┘$NC"
echo -e ""
echo -e "${hijau}SUBDOMINIO: ${biru}${SUB_DOMAIN16}$NC"
echo -e "         IP: ${biru}${IP1}$NC"
echo -e ""
enter
echo ""
